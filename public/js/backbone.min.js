/*! This file is auto-generated */ ! function (n) {
    ...
    n.on = function (t, e, i) {
        return this._events = c(s, this._events || {}, t, e, {
            context: i,
            ctx: this,
            listening: a
        }), a && (((this._listeners || (this._listeners = {}))[a.id] = a).interop = !1), this
    }, n.listenTo = function (t, e, i) {
        if (!t) return this;
        var n = t._listenId || (t._listenId = b.uniqueId("l")),
            s = this._listeningTo || (this._listeningTo = {}),
            r = a = s[n];
        r || (this._listenId || (this._listenId = b.uniqueId("l")), r = a = s[n] = new g(this, t));
        t = l(t, e, i, this);
    ...
    n.off = function (t, e, i) {
        return this._events && (this._events = c(r, this._events, t, e, {
            context: i,
    ...
    g.prototype.on = n.on, g.prototype.off = function (t, e) {
        e = this.interop ? (this._events = c(r, this._events, t, e, {
            context: void 0,
            listeners: void 0
    ...
    b.extend(v.prototype, n, {
        ...
        set: function (t, e, i) {
            ...
            var s = i.unset,
                ...
                o = [],
                t = this._changing;
            this._changing = !0, t || (this._previousAttributes = b.clone(this.attributes), this.changed = {});
            var h, a = this.attributes,
                u = this.changed,
                c = this._previousAttributes;
            for (h in n) e = n[h], b.isEqual(a[h], e) || o.push(h), b.isEqual(c[h], e) ? delete u[h] : u[h] = e, s ? delete a[h] : a[h] = e;
            if (this.idAttribute in n && (this.id = this.get(this.idAttribute)), !r) {
                o.length && (this._pending = i);
                for (var l = 0; l < o.length; l++) this.trigger("change:" + o[l], this, a[o[l]], i)
            }
            if (t) return this;
            if (!r)
        ...
        fetch: function (i) {
            ...
            }, B(this, i), this.sync("read", this, i)
        },
        save: function (t, e, i) {
            var n;
            ...
            }, B(this, i), n && s && (this.attributes = b.extend({}, h, n));
        ...
        destroy: function (e) {
            ...
            return this.isNew() ? b.defer(e.success) : (B(this, e), t = this.sync("delete", this, e)), r || i(), t
        },
        url: function () {
            var t = b.result(this, "urlRoot") || b.result(this.collection, "url") || F();
    ...
    b.extend(m.prototype, n, {
        ...
        _prepareModel: function (t, e) {
            ...
            return t.validationError ? (this.trigger("invalid", this, t.validationError, e), !1) : t
        },
        _removeModels: function (t, e) {
            for (var i = [], n = 0; n < t.length; n++) {
                var s, r, o = this.get(t[n]);
                o && (s = this.indexOf(o), this.models.splice(s, 1), this.length--, delete this._byId[o.cid], null != (r = this.modelId(o.attributes)) && delete this._byId[r], e.silent || (e.index = s, o.trigger("remove", o, this, e)), i.push(o), this._removeReference(o, e))
            }
            return i
        },
        _isModel: function (t) {
        ...
        _onModelEvent: function (t, e, i, n) {
            if (e) {
                ...
                var s, r;
                "destroy" === t && this.remove(e, n), "change" !== t || (s = this.modelId(e.previousAttributes())) !== (r = this.modelId(e.attributes)) && (null != s && delete this._byId[s], null != r && (this._byId[r] = e))
            }
    ...
    y && (E.prototype[y] = function () {
        ...
        if (this._collection) {
            if (this._index < this._collection.length) {
                ...
                return this._index++, {
                    value: this._kind === k ? e : (t = this._collection.modelId(e.attributes), this._kind === I ? t : [t, e]),
                    done: !1
                }
            }
    ...
    b.extend(e.prototype, n, {
        ...
        delegateEvents: function (t) {
            ...
            for (var e in this.undelegateEvents(), t) {
                var i = t[e];
                (i = !b.isFunction(i) ? this[i] : i) && (e = e.match(T), this.delegate(e[1], e[2], i.bind(this)))
            }
            return this
        },
    ...
    var $ = function (e, t) {
            return b.isFunction(e) ? e : b.isObject(e) && !t._isModel(e) ? A(e) : b.isString(e) ? function (t) {
                return t.get(e)
            } : e
        },
        A = function (t) {
    ...
    b.each([
        ...
        n.url || (r.url = b.result(e, "url") || F()), null != n.data || !e || "create" !== t && "update" !== t && "patch" !== t || (r.contentType = "application/json", r.data = JSON.stringify(n.attrs || e.toJSON(n))), n.emulateJSON && (r.contentType = "application/x-www-form-urlencoded", r.data = r.data ? {
            model: r.data
    ...
    b.extend(y.prototype, n, {
        ...
        _routeToRegExp: function (t) {
            return t = t.replace(j, "\\$&").replace(R, "(?:$1)?").replace(M, function (t, e) {
                return e ? t : "([^/?]+)"
    ...
    var O = h.History = function () {
        ...
        z = /^\/+|\/+$/g,
        q = /#.*$/;
    O.started = !1, b.extend(O.prototype, n, {
        interval: 50,
        atRoot: function () {
        ...
        getFragment: function (t) {
            return (t = null == t ? this._usePushState || !this._wantsHashChange ? this.getPath() : this.getHash() : t).replace(U, "")
        },
        start: function (t) {
            if (O.started) throw new Error("Backbone.history has already been started");
            if (O.started = !0, this.options = b.extend({
                    root: "/"
        ...
        navigate: function (t, e) {
            ...
            var i = this.root,
                n = (i = "" === t || "?" === t.charAt(0) ? i.slice(0, -1) || "/" : i) + t;
            t = t.replace(q, "");
    ...
    v.extend = m.extend = y.extend = e.extend = O.extend = function (t, e) {
        var i = this,
