...
tinymce.baseURL = "https://cdn.tiny.cloud/1/no-api-key/tinymce/5.8.2-114"
    ...
    ! function () {
        ...
        function e(t) {
            var e = t.command;
            return n(_, e) ? function (t) {
                if (!f(t.value)) {
                    t = t.value["list-style-type"];
                    return "advlist_" + ("" === t ? "default" : t)
                }
            }(t) : n(g, e) ? g[e] : n(p, e) ? p[e] : n(S, e) ? S[e] : void 0
        }
        ...
        var r, a, i, s, u, d, l = (r = "string", function (t) {
                return t = typeof (e = t), (null === e ? "null" : "object" == t && (Array.prototype.isPrototypeOf(e) || e.constructor && "Array" === e.constructor.name) ? "array" : "object" == t && (String.prototype.isPrototypeOf(e) || e.constructor && "String" === e.constructor.name) ? "string" : t) === r;
                var e
            }),
            f = (a = void 0, function (t) {
                return a === t
            }),
        ...
        s = tinymce.defaultSettings, u = {
            load: o
        }, d = function (t) {
            t = t.api_key;
            return l(t) ? t : void 0
        }(s), u = void 0 === d ? u : ((i = t(s, d)).sendStat("script_load"), {
            load: function (t) {
                t.once("init", function () {
                    return i.sendStat("init")
                }), t.once("focus", function () {
                    return i.sendStat("focus")
                }), t.on("ExportPdf", function () {
                    return i.sendStat("export_pdf")
                }), t.on("PastePreProcess PowerPasteTempStats", function (t) {
                    t = t.source;
                    null == t || i.sendStat("powerpaste_" + t)
                }), t.on("VisualChars", function (t) {
                    !0 === t.state && i.sendStat("visualchars_true")
                    ...
                    return i.sendStat("rtc_error")
                }), t.on("RtcSessionDirty", function () {
                    return i.sendStat("rtc_edited")
