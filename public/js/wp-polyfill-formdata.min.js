...
(function () {
    ...
    if ("undefined" === typeof FormData || !FormData.prototype.keys) {
        var N = function (a, b) {
            ...
            R = "object" === typeof window ? window : "object" === typeof self ? self : this,
            S = R.FormData,
        ...
        V && (Blob.prototype[V] || (Blob.prototype[V] = "Blob"), "File" in R && !File.prototype[V] && (File.prototype[V] = "File"));
        try {
            new File([], "")
        } catch (a) {
            R.File = function (b,
        ...
        var Y = function (a) {
            ...
            N(a.elements, function (a) {
                a.name && !a.disabled && "submit" !== a.type && "button" !== a.type && ("file" === a.type ? N(a.files || [], function (c) {
                    b.append(a.name,
                        c)
                }) : "select-multiple" === a.type || "select-one" === a.type ? N(a.options, function (c) {
                    !c.disabled && c.selected && b.append(a.name, c.value)
                }) : "checkbox" === a.type || "radio" === a.type ? a.checked && b.append(a.name, a.value) : b.append(a.name, a.value))
            })
        };
        k = Y.prototype;
        ...
        Y.prototype._asNative = function () {
            for (var c =
                    new S, e = x(this), f = e.next(); !f.done; f = e.next()) {
                var g = x(f.value);
                f = g.next().value;
                g = g.next().value;
                c.append(f, g)
        ...
        T && (XMLHttpRequest.prototype.send = function (c) {
            c instanceof
