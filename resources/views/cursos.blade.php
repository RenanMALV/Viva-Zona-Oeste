    ...
    <section class="content-area">
        <div class="top_heading_out">
            <div class="top_site_main"
                style="color: #ffffff;background-image:url(\\storage\\{{ addslashes(setting('site.img_cursos')) }});">
                <span class="overlay-top-header" style="background-color:rgba(0,0,0,0.5);"></span>
                <div class="page-title-wrapper">
                    <div class="banner-wrapper container">
                        <h1>Cursos do Viva Zona Oeste</h1>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="course-item">
                                        <div class="course-thumbnail">
                                            <a href="/curso/{{$curso -> slug}}">
                                                <img src="/storage/{{ $curso->imagem }}" alt="LMS Interactive Content"
                                                    title="course-4" width="400" height="300" style="object-fit: scale-down; width: 400px; height: 300px"> </a>
                                            <a class="course-readmore"
                                                href="/curso/{{$curso -> slug}}">Saiba
                                                Mais</a>
                                        </div>
                                        <div class="thim-course-content">
                                            <h2 class="course-title"><a
                                                    href="/curso/{{$curso -> slug}}"
                                                    rel="bookmark">{{ $curso->name }}</a></h2>
