    ...
    <section class="content-area">
        <div class="top_heading_out">
            <div class="top_site_main"
                style="color: #ffffff;background-image:url(\\storage\\{{addslashes(setting('site.img_faq'))}});">
                            ...
                            <div id="pl-4526" class="panel-layout">
                                ...
                                <div class="thim-widget-accordion template-base">
                                    <div class="thim-widget-accordion">
                                        <h3 class="widget-title">Perguntas e Respostas</h3>
                                        <div id="accordion_61314881bcbec" class="panel-group" role="tablist" aria-multiselectable="true">

                                            @foreach ($faqs as $faq)
                                                
                                            <div class="panel panel-default">

                                                <div class="panel-heading" role="tab" id="heading_accordion_61314881bcbec_{{$faq ->id}}">
                                                    <h4 class="panel-title">
                                                        <a role="button" class="collapsed" data-toggle="collapse" data-parent="#accordion_61314881bcbec" href="#collapse_accordion_61314881bcbec_{{$faq ->id}}" aria-expanded="false" aria-controls="collapse_accordion_61314881bcbec_{{$faq ->id}}">
                                                            {{$faq -> pergunta}} 
                                                        </a>
                                                    </h4>
                                                </div>

                                                <div id="collapse_accordion_61314881bcbec_{{$faq ->id}}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_accordion_61314881bcbec_{{$faq ->id}}">
