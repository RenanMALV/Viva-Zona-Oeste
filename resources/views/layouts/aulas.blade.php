...
<head>
    ...
    <script type='text/javascript' src='https://code.jquery.com/jquery-3.5.0.js' id='jquery-core-js'></script>
...
<body
    ...
    <script type='text/javascript' src='/js/custom-script-v2.js' id='thim-custom-script-js'></script>
    ...
    <script>
        function aumenta(){
            ...
            //$("#popup-sidebar").attr('flex',);
            $("#aumenta").toggle();
            $("#diminui").toggle();
            $("#popup-sidebar").css({"flex": "0 0 0"});
            $("#popup-header").css({"width": "100%", "left": "0"});
        ...
        function diminui(){
            ...
            $("#aumenta").toggle();
            $("#diminui").toggle();
            $("#popup-sidebar").css({"flex": ""});
            $("#popup-header").css({"width": "", "left": ""});
            return false;
        }
